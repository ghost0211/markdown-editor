...
describe('Release Acceptance & Quality Assurance (v1.2.0)', () => {
  describe('Consistent Release Version 1.2.0 across all Project Manifests', () => {
    const rootDir = resolve(__dirname, '..');

    it('package.json should have version 1.2.0', () => {
      const pkg = JSON.parse(readFileSync(resolve(rootDir, 'package.json'), 'utf-8'));
      expect(pkg.version).toBe('1.2.0');
    });

    it('package-lock.json should have root version 1.2.0', () => {
    ...
    it('Cargo.toml should have version 1.2.0', () => {
    ...
    it('Cargo.lock should have markdown-editor package version 1.2.0', () => {
